...
import OrbitingDots from "./components/OrbitingDots";
import AOS from 'aos';
    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            ...
            <h1 className="text-5xl font-bold mb-3">
              <ShinyText text="Hi I'm METHEFOR" disabled={false} speed={3} className='custom-class' />
            </h1>
            <h2 className="text-2xl font-semibold text-violet-400 mb-6">
              Full Stack Developer &amp; AI Engineer
            </h2>
            <BlurText
              text="Building elegant solutions for complex problems"
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I work as a Full Stack Developer. I do this job with great enthusiasm and intensity. I enjoy creating elegant solutions to complex problems using modern web technologies.."
                  delay={150}
                  animateBy="words"
                  direction="top"
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  ...
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      Metehan<span className="text-violet-500"> Arslan</span>
                    </h1>
                    <p>Full Name</p>
                  </div>
                </div>
        ...
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
          ...
          <div className="flex justify-center mb-10" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="350" data-aos-once="true">
            <OrbitingDots />
          </div>

          <div className="max-w-2xl mx-auto">
            <form
              action="https://formsubmit.co/methefor@gmail.com"
              method="POST"
